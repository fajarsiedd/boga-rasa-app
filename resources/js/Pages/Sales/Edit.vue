...
watch(isPaid, () => {
    if (!isPaid.value) {
        const today = new Date(props.sale.created_at);
                    ...
                    <form @submit.prevent="submitForm">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div v-if="form.errors.due_date && !form.is_paid" class="text-red-600 text-sm mt-1">
                                        {{
                        ...
                        <div class="space-y-4">
                            <SaleDetailRow v-for="(detail, index) in form.details" :key="`detail-${index}`"
                                ...
                                @update:detail="form.details[index] = $event" @remove="removeProductDetail(index)" />
                        </div>
