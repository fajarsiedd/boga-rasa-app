...
const form = useForm({
    supplier_id: props.purchasePlan.supplier_id,
    description: props.purchasePlan.description,
    details: props.purchasePlan.details.map(detail => ({
        id: detail.id,
...
const submitForm = () => {
    form.put(route('rencana-pembelian.update', props.purchasePlan.id), {
        onSuccess: () => {
            form.reset();
...
<template>
    ...
    <Head title="Setujui Rencana Pembelian" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <span class="text-gray-700 text-sm">{{ new
                                    Date(props.purchasePlan.created_at).toLocaleDateString('id-ID')
                                }}</span>
                            </div>
                        </div>
