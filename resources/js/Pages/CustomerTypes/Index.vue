            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <Link :href="route('tipe-konsumen.create')"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden shadow">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-if="customer_types.length === 0">
                                    <td colspan="4"
                                        class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">
                                        Belum ada data tipe konsumen.
                                    </td>
                                </tr>
                                <tr v-for="customer_type in customer_types" :key="customer_type.id">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <Link :href="route('tipe-konsumen.edit', customer_type.id)"
                                            class="text-indigo-600 hover:text-indigo-900 mr-4">Edit</Link>
                                        <button @click="deleteCustomerType(customer_type.id)"
