...
const canCreate = computed(() => usePage().props.auth.user.can['create-material']);
    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <div class="flex flex-row items-center justify-start">
                <h2 class="font-semibold text-lg text-gray-700 leading-tight mr-6">Daftar Bahan Baku</h2>
                <div
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-700">
                        ...
                        <div v-if="materials.length > 0" class="flex justify-end items-center mb-4">
                            <Link v-if="canCreate" :href="route('bahan-baku.create')"
                        ...
                        <div v-if="materials.length === 0"
                            ...
                            <p class="font-semibold mb-2">Belum ada data bahan baku</p>
