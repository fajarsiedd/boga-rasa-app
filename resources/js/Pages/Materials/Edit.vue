...
<template>
    ...
    <Head :title="`Edit Bahan Baku: ${material.name}`" />
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form @submit.prevent="submit">
                        <div class="mb-4">
                            <label for="name" class="block text-sm font-medium text-gray-700">Nama Bahan Baku <span
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <Link :href="route('bahan-baku.index')" class="text-gray-600 hover:text-gray-900 mr-4">
                            Batal</Link>
                            <button type="submit"
